...
namespace Bike-Shop.Logic.DataContext
{
    internal partial class ProjectDbContext : DbContext
    {
        private static readonly string ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Database=Bike-ShopDb;Integrated Security=True";
